...
impl ErrorKind {
    pub fn as_str(&self) -> &'static str {
        match *self {
            ...
            ErrorKind::StateNotDefined => "state not defined",
            ErrorKind::StateAlreadyDefined => "state already defined",
            ErrorKind::TransitionAlreadyDefined => "transition already defined",
